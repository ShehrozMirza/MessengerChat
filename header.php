    ...
    <nav class="top-header">
        <div class="container">
            <div class="top-header-inner">
                <a class="top-header-brand" href="index.php?r=<?= $randstr ?>">
...
<?php if ($loggedin): ?>
                <div class="top-header-user">
                    <?php if (file_exists('uploads/' . $user . '.jpg')): ?>
                        <img src="uploads/<?= rawurlencode($user) ?>.jpg" class="header-avatar" alt="<?= $userstr ?>">
                    <?php else: ?>
    ...
    <div class="tab-bar">
        <div class="container">
            <div class="tab-bar-inner">
                <a class="tab-item<?= $currPage === 'index.php' ? ' active' : '' ?>" href="index.php?r=<?= $randstr ?>">
                    <i class="bi bi-house-door-fill"></i>
                    <span>Home</span>
                </a>
                <a class="tab-item<?= $currPage === 'friends.php' ? ' active' : '' ?>" href="friends.php?r=<?= $randstr ?>">
                    <i class="bi bi-heart-fill"></i>
                    <span>Friends</span>
                </a>
                <a class="tab-item<?= $currPage === 'members.php' ? ' active' : '' ?>" href="members.php?r=<?= $randstr ?>">
                    <i class="bi bi-people-fill"></i>
                    <span>Members</span>
                </a>
                <a class="tab-item<?= $currPage === 'messages.php' ? ' active' : '' ?>" href="messages.php?r=<?= $randstr ?>">
                    <i class="bi bi-chat-dots-fill"></i>
                    <span>Messages</span>
                </a>
                <a class="tab-item<?= $currPage === 'profile.php' ? ' active' : '' ?>" href="profile.php?r=<?= $randstr ?>">
    ...
    <div class="tab-bar">
        <div class="container">
            <div class="tab-bar-inner justify-content-center gap-2">
                ...
                <a class="tab-item<?= $currPage === 'signup.php' ? ' active' : '' ?>" href="signup.php?r=<?= $randstr ?>">
                    <i class="bi bi-person-plus-fill"></i>
                    <span>Sign Up</span>
                </a>
                <a class="tab-item<?= $currPage === 'login.php' ? ' active' : '' ?>" href="login.php?r=<?= $randstr ?>">
            ...
            <div class="modal-content" style="border:none;border-radius:14px">
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-3">
                        ...
                        <a href="logout.php?r=<?= $randstr ?>" class="btn btn-danger px-4">
